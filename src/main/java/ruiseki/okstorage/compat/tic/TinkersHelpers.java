package ruiseki.okstorage.compat.tic;
...
public class TinkersHelpers {
    ...
    private static void createCraftingStationInstance() {
        try {
            ...
            OKStorage.okLog(Level.ERROR, "Error getting instance of Tinkers Crafting Station: " + e);
        }
    }
    ...
    public static synchronized ItemStack getTinkersRecipe(InventoryCrafting craftMatrix) {
        ...
        try {
            ...
            OKStorage.okLog(Level.ERROR, "Error during reflection in getTinkersRecipe: " + e);
            return null;
        }
    }
}
