package ruiseki.okstorage.common.item.feeding;
...
public class ItemAdvancedFeedingUpgrade extends ItemUpgrade<AdvancedFeedingUpgradeWrapper> {
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer entityplayer, List<String> list, boolean flag) {
        list.add(LangHelpers.localize("tooltip.storage.advanced_feeding_upgrade"));
        list.add(LangHelpers.localize("tooltip.storage.advanced_filter_upgrade.1"));
    }
