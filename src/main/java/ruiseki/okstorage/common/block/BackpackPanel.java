...
import ruiseki.okstorage.client.gui.slot.BackpackSlot;
import ruiseki.okstorage.client.gui.slot.CraftingSlotInfo;
import ruiseki.okstorage.client.gui.slot.ModularBackpackSlot;
...
import ruiseki.okstorage.client.gui.widget.BackpackList;
import ruiseki.okstorage.client.gui.widget.BackpackSearchBarWidget;
...
public class BackpackPanel extends ModularPanel implements IStoragePanel<BackpackPanel> {
    ...
    public BackpackPanel(EntityPlayer player, TileEntity tile, PanelSyncManager syncManager, UISettings settings,
        BackpackWrapper wrapper, int width) {
        super("backpack_gui");
        this.player = player;
        this.tile = tile;
        ...
        this.settings.customContainer(() -> new BackPackContainer(wrapper));
